        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="owl-carousel item-carousel">
                    ...
                    <div class="items">
                        <div class="item-box">
                            <img src="{{ asset('assets/images/food-icon/4.png')}}" alt="">
                            <h5 class="title mb-0">burger</h5>
                        </div>
                    </div>
                    <div class="items">
                        <div class="item-box">
                            <img src="{{ asset('assets/images/food-icon/5.png')}}" alt="">
                            <h5 class="title mb-0">chinese</h5>
                        </div>
                    </div>
                    <div class="items">
                        <div class="item-box">
                            <img src="{{ asset('assets/images/food-icon/6.png')}}" alt="">
                            <h5 class="title mb-0">vegetable</h5>
                        </div>
                    </div>
                    <div class="items">
                        <div class="item-box">
                            <img src="{{ asset('assets/images/food-icon/7.png')}}" alt="">
                ...
                <div class="row">
                    <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-12 col-sm-6">
                        <div class="card item-card">
                            <div class="card-body p-0">
                                <img src="{{ asset('assets/images/dish/1.jpg')}}" class="img-fluid" alt="">
                                <div class="info">
                                    <h5 class="name">Cheese Burger</h5>
                                    <h6 class="mb-0 price">$6.00</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-12 col-sm-6">
                        <div class="card item-card">
                            <div class="card-body p-0">
                                <img src="{{ asset('assets/images/dish/2.jpg')}}" class="img-fluid" alt="">
                                <div class="info">
                    ...
                    <div class="col-xl-3 col-xxl-4 col-lg-6 col-md-12 col-sm-6">
                        <div class="card item-card">
                            <div class="card-body p-0">
                                <img src="{{ asset('assets/images/dish/3.jpg')}}" class="img-fluid" alt="">
                                <div class="info">
