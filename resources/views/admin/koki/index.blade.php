                ...
                @foreach ($data as $datum)
                    ...
                    class="card-container cursor-pointer">
                        <div class="card  shadow-sm">
                             <div class="card-header text-white" :class="!isLoading ? (status == 'Menunggu' ? 'bg-warning' : 'bg-success') : 'bg-secondary'">
                                <div>
                                    <h4 class="text-white">DiResto</h4>
                                    <span class="fs-12 op9">{{$datum->no_transaksi}}</span>
                                </div>
                                <h3 class="text-white" x-text="!isLoading ? (status == 'Menunggu' ? 'Menunggu' : 'Selesai') : 'Memuat ...';"></h3>
                            </div>
                            <div class="card-body">
                                <ul class="order-list">
